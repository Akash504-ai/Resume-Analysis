...
import { MessageCircle, Send, Smile, Users, ShieldCheck, Zap, ChevronDown } from "lucide-react";
...
const Community = () => {
  ...
  const formatDateLabel = (date) => {
    ...
    const diff = Math.floor((today.setHours(0,0,0,0) - msgDate.setHours(0,0,0,0)) / 86400000);
      ...
      <main className="flex-1 ml-20 md:ml-64 flex flex-col h-screen relative z-10">
        ...
        <header className="px-8 py-6 border-b border-white/5 bg-[#030014]/50 backdrop-blur-xl flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-black text-white tracking-tight uppercase">Community<span className="text-pink-500">_</span>HUB</h1>
        ...
        <div className="flex-1 flex overflow-hidden">
              ...
              <div className="flex-1 flex items-center justify-center p-6">
                ...
                >
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed mb-8">
                    Sync your neural link with the Nexus network to start sharing resources and insights with elite developers.
                  </p>
                  <button
                    onClick={handleJoin}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={`flex ${isMe ? "justify-end" : "justify-start"} items-end gap-3`}>
                            ...
                            <div className={`group relative max-w-[75%] md:max-w-md px-5 py-3 rounded-2xl transition-all duration-300 ${
                              isMe 
                              ...
                              <span className={`text-[9px] mt-1.5 block opacity-40 font-bold ${isMe ? "text-right" : "text-left"}`}>
                    ...
                    <div className="relative">
                      <button
                        ...
                        className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${
                          showEmoji ? "bg-pink-500 text-white" : "bg-white/5 text-gray-500 hover:text-white"
                        }`}
                      >
                        <Smile size={20} />
                      </button>
          ...
          {/* SIDEBAR: CHANNEL INFO (Desktop Only) */}
          <aside className="hidden lg:flex w-72 border-l border-white/5 bg-[#030014]/30 flex-col p-8">
            <div className="mb-10">
              <h3 className="text-[10px] font-black text-gray-600 uppercase tracking-[0.2em] mb-6">Channel Protocol</h3>
              <ul className="space-y-4">
                <ProtocolItem icon={<ShieldCheck size={14}/>} text="Civil Dialogue Only" />
                <ProtocolItem icon={<Zap size={14}/>} text="No Spam Packets" />
                <ProtocolItem icon={<Users size={14}/>} text="Share Open Source" />
              </ul>
            </div>

            <div className="mt-auto p-6 bg-gradient-to-br from-indigo-600/20 to-pink-600/20 border border-white/5 rounded-3xl">
              <p className="text-xs font-bold text-white mb-2 tracking-tight">Community Notice</p>
              <p className="text-[10px] text-gray-500 leading-relaxed">
                Messages are encrypted via Nexus-V3. Always keep your credentials secure.
              </p>
            </div>
          </aside>

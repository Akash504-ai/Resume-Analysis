  ...
  return (
    <div className="relative min-h-screen w-full bg-[#030014] selection:bg-indigo-500/30 overflow-hidden flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="flex flex-col items-start space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-lg font-light max-w-[280px] leading-relaxed">
              Verify your{" "}
              <span className="text-gray-200">neural signature</span> to
              continue.
            </p>
          </div>
        </div>
        ...
        <motion.div className="relative bg-[#0a0a0c]/60 border border-white/5 rounded-[3.5rem] p-10 backdrop-blur-2xl shadow-[0_30px_100px_rgba(0,0,0,0.5)] w-full max-w-md mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-end">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-[10px] text-indigo-400 hover:text-indigo-300 font-bold uppercase tracking-widest transition"
                  >
                    Lost Key?
                  </Link>
                </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-500 text-sm font-medium">
              ...
              <Link
                to="/register"
                className="text-indigo-400 hover:text-indigo-300 transition ml-1 underline-offset-4 hover:underline"
              >
                Create Identity
              </Link>
            </p>

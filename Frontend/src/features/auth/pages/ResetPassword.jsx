...
import { Lock, ShieldAlert, CheckCircle2, Loader2, ArrowRight, ArrowLeft } from "lucide-react";
        ...
        <div className="relative bg-[#0a0a0c]/60 border border-white/5 rounded-[3.5rem] p-10 backdrop-blur-2xl shadow-[0_30px_100px_rgba(0,0,0,0.5)]">
          ...
          <header className="mb-10">
            ...
            <h1 className="text-3xl font-black text-white tracking-tighter mb-2 uppercase">
              Rewrite <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-fuchsia-400 italic font-light">Access</span>
            </h1>
          ...
          <form onSubmit={handleReset} className="space-y-6 relative z-10">
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-indigo-500 transition-colors" size={18} />
                <input
                  required
                  type="password"
                  placeholder="••••••••"
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-fuchsia-500 transition-colors" size={18} />
                <input
                  required
                  type="password"
                  placeholder="••••••••"
            ...
            >
              ...
              {loading ? (
                ...
                <>
                  <span className="tracking-[0.2em] uppercase text-xs">Commit Changes</span>
